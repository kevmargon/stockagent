			...
			<div class="dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<c:forEach items="${listC}" var="category"> 
					 <a class="dropdown-item" href="${pageContext.request.contextPath}/AdminProductServ?action=LISTCAT&id=${category.id}&nameCat=${category.name}">${category.name}</a>
					</c:forEach>
				</div>
			</div>
			...
			<c:forEach items="${listP}" var="product">
				<tr>
					...
					<td> 
						...
						|
						<a href="${pageContext.request.contextPath}/AdminProductServ?action=EDIT&id=${product.id}"><span class="fa fa-edit"></span></a>
				   		| 
